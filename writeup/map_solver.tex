...
This note describes the mathematical model used to estimate a relative planar pose constraint between two stationary lidar scan bundles. The resulting relative pose and covariance may be used as a factor-graph edge, for example as a GTSAM \texttt{BetweenFactor<Pose2>}.
